...
public class DAO {
    ...
    public DAO() {
        ...
        // 테스트용 데이터
        MemberDTO m1 = new MemberDTO(0, "test", 11, "서울");
        MemberDTO m2 = new MemberDTO(1, "test", 22, "대전");
        MemberDTO m3 = new MemberDTO(2, "test", 33, "대구");
        MemberDTO m4 = new MemberDTO(3, "test", 44, "부산");
        mlist.add(m1);
        mlist.add(m2);
        mlist.add(m3);
        mlist.add(m4);
