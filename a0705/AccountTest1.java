...
public class AccountTest1 {
    public static void main(String[] args) {
        ...
        //while 루프를 이용해서 a계좌에서 b계좌로 3000원을 이제하는 동안 반복
        //tqansfer 메서드는 이체가 성공하면 'true'를 반환하고
        //실패하면 false 를 반환
...
class Account1 {
    ...
    public boolean transfer(Account1 account1,  int amount) {
        ...
        balance -= amount; // A의 balance 를 amount(3000)을 빼서 다시 balance에 저장
        account1.balance += amount; 
        //B의 balance 를 amount(3000)을 더해서 balance에 저장
        return true;
    }
    public String toStr() {
